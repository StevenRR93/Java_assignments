...
//     aLeague.showTable();
 ...
 //   aLeague.showTable();
    ...
    System.out.println("The total number of games played is " +
                        aLeague.totalGamesPlayed());
    System.out.println("The first place team is " +
                        aLeague.firstPlaceTeam());
    System.out.println("The last place team is " +
                        aLeague.lastPlaceTeam());
	...
	System.out.println("\nThere are " + undefeated.length + " undefeated teams as follows:");
    ...
    System.out.println(aLeague.havePlayedTogether("I Love 2013", "Frank"));
